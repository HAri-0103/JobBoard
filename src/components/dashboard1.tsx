...
export default function Dashboard1(props:dashboardProps){
    return(
        <div className="w-[600px] flex justify-between items-center border my-1 bg-white rounded-xl" >
            <div className="flex justify-start items-center space-x-5 p-10">
